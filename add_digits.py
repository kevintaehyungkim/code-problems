...
O(1) space
'''
# can simply reduce to mod 9:
# all numbers divisible by 9 have digit sums of 9 (single digit)
# thus digit sums of all other numbers before every multiple of 9 can be found mod 9
# however, in cases where num is multiple of 9,subtract 1 before %9 and then add 1 because
